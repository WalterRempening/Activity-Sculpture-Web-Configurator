/**
 * Configurator API
 * Endpoints for querying user data from the configurator
 * and for authentication through oAuth
 */

// import request and Withings modules
var request = require( 'request' );
var wApi = require( './withingsApi' );
var WCUser = require( './models/user' );

/**
 * Check if user object is availabe in request object
 * @param req
 * @param res
 * @param next
 * @returns {*}
...
/**
 * Filter objects with duplicate dates
 * @param data
 * @returns {Array}
 */
...
/**
 * Order data according to ascending date
 * @param data
 * @returns {Array with ordered data}
 */
